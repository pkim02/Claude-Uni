...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // MVP: Simple demo login — skip actual auth
    if (email && password) {
      localStorage.setItem("claude-uni-user", JSON.stringify({ email, id: "demo-user" }));
  ...
  function handleDemoLogin() {
    localStorage.setItem(
      "claude-uni-user",
      JSON.stringify({ email: "demo@claude.university", id: "demo-user" })
    );
    router.push("/dashboard");
  }
